...
bool MqttProtocol::StartMqttClient(bool report_error) {
    ...
    auto endpoint = settings.GetString("endpoint", "mqtt://192.168.18.164:1883");
    auto client_id = settings.GetString("client_id");
    auto username = settings.GetString("username","user1");
    auto password = settings.GetString("password","axjIWLAMMXA.SAKFN5321ZASHV");
    int keepalive_interval = settings.GetInt("keepalive", 240);
    publish_topic_ = settings.GetString("publish_topic","gooffice");
