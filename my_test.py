...
from navigation_msgs.msg import NavigationStatus,Quaternion
import math
...
class NavigationManager:
    ...
    def init_ros(self):
        # 初始化发布者
        self.pub_nav_goal = rospy.Publisher("/move_base_simple/goal", PoseStamped, queue_size=1)
        # 订阅导航状态
        rospy.Subscriber("/navigation_status", NavigationStatus, self.update_nav_status, queue_size=1)
